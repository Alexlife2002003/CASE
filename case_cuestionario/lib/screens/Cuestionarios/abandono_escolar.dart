import 'package:case_cuestionario/Datos/datosAbandonoEscolar.dart';
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                buildText(pregunta50),
                Column(
                  children: [
                    helper.buildCheckboxRow(
                        'Horarios complicados de clases', horariosComplicados,
                        (value) {
                      setState(() {
                    ...
                    helper.buildCheckboxRow(
                        'No era mi vocación la carrera', noVocacion, (value) {
                      setState(() {
                        noVocacion = value!;
                      });
                    }),
                    ...
                    helper.buildCheckboxRow(
                        'No me gustaron las materias', noGustaronMaterias,
                        (value) {
                      setState(() {
                    ...
                    helper.buildCheckboxRow(
                        'Dificultad en las materias', dificultadMaterias,
                        (value) {
                      setState(() {
                    ...
                    helper.buildCheckboxRow(
                        'Situación económica difícil', situacionEconomica,
                        (value) {
                      setState(() {
                    ...
                    helper.buildCheckboxRow(
                        'Tener que trabajar', tenerQueTrabajar, (value) {
                      setState(() {
                ...
                buildText(pregunta51),
                Row(
                  children: [
                    for (var option in respuesta51)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta51, (value) {
                        setState(() {
                ...
                buildText(pregunta52),
                Row(
                  children: [
                    for (var option in respuesta52)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta52, (value) {
                        setState(() {
                ...
                buildText(pregunta54),
                Column(
                  children: [
                    for (var option in respuesta54)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta54, (value) {
                        setState(() {
                ...
                buildText(pregunta55),
                Column(
                  children: [
                    for (var option in respuesta55)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta55, (value) {
                        setState(() {
                ...
                buildText(pregunta56),
                buildText(pregunta57),
                buildText(pregunta58),
                Row(
                  children: [
                    for (var option in respuesta58)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta58, (value) {
                        setState(() {
                ...
                buildText(pregunta59),
                Row(
                  children: [
                    for (var option in respuesta59)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta59, (value) {
                        setState(() {
                ...
                buildText(pregunta60),
                 Column(
                  children: [
                    for (var option in respuesta60)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta60, (value) {
                        setState(() {
                ...
                buildText(pregunta61),
                 Column(
                  children: [
                    for (var option in respuesta61)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta61, (value) {
                        setState(() {
                ...
                buildText(pregunta62),
                  Column(
                  children: [
                    for (var option in respuesta62)
                      helper.buildRadioButton(
                          option, option, _selected_pregunta62, (value) {
                        setState(() {
